 ...
 * `notFound()`, not a generic empty state, for a trip that doesn't exist or
 * isn't the caller's — matches every other resource's "denial reads as not
 * found" convention (`_lib/authz.ts`'s header comment).
 */
